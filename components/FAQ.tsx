...
export default function FAQ({ items, title = 'Остались вопросы?' }: FAQProps) {
  ...
  return (
    <section className="py-12 desktop:py-16" id="faq">
      <div className="max-w-[920px] mx-auto px-4">
        <div className="flex flex-col desktop:flex-row gap-8 desktop:gap-16">
          <div className="desktop:w-48 shrink-0">
            <h2
              className="text-3xl desktop:text-4xl leading-tight"
          ...
          <div className="flex-1 divide-y divide-gray-200">
            {items.map((item, i) => (
              <div key={i} className="py-4">
                ...
                >
                  <h3
                    className="text-base desktop:text-lg text-[#2b2b2b]"
                ...
                {openIndex === i && (
                  <div
                    className="mt-3 text-[#555] text-sm desktop:text-base leading-relaxed"
